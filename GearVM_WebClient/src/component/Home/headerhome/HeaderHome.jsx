...
import styles from "./HeaderHome.modulo.scss";
...
const HeaderHome = () => {
  document.addEventListener("scroll", () => {
    ...
    if (top != 0) {
      document.querySelector(".wrapnav_about_home")?.classList.add("sticky");
      // document.querySelector('.wrapnav_about').setAttribute('class','sticky')
    } else {
      document.querySelector(".wrapnav_about_home")?.classList.remove("sticky");
    }
  });
  ...
  return (
    <div className={cx("wrap")}>
      ...
      <div className="wrapnav_about_home">
