    ...
    <div className={cx('wrapPayBody')}>
        <div className={cx('wrapPayBody_right')}>          
            <div className={cx('wrapPayBody_right_address')}>
                ...
                <div className={cx('wrapPayBody_right_address_btn')} onClick={handleShow}>
                  <h3>+</h3>
                  <h5  >Thêm Địa chỉ
                  </h5> 
                </div>  
            ...
            <div className={cx('wrapPayBody_right_metodpay')}>
                ...
                <div className={cx('wrapPayBody_right_metodpay_wrapbtn')}>
                    <div className={cx('wrapPayBody_right_address_btn')}>
                      ...
                      <h6>Thanh toán qua Internet Banking, Visa, Master, JCB, VNPAY-QR</h6> 
                    </div>
                    <div className={cx('wrapPayBody_right_address_btn')}>
        ...
        <div className={cx('wrapPayBody_left')}>          
            ...
            <div className={cx('wrapPayBody_right_Sumpay')}>
                ...
                <div className={cx('wrapPayBody_right_Sumpay_content')}>
                    <span className={cx('wrapPayBody_right_Sumpay_text')}>Tổng tạm tính:</span>
                    <span className={cx('wrapPayBody_right_Sumpay_text')}>75.768.000₫</span>
                </div>
                <div className={cx('wrapPayBody_right_Sumpay_content')}>
                    <span className={cx('wrapPayBody_right_Sumpay_text')}>Phí vận chuyển</span>
                    <span className={cx('wrapPayBody_right_Sumpay_text')}>Miễn phí</span>
                </div>
                <div className={cx('wrapPayBody_right_Sumpay_content')}>
                    <span className={cx('wrapPayBody_right_Sumpay_text')}>Thành Tiền:</span>
                    <span className={cx('wrapPayBody_right_Sumpay_text_red')}>75.768.000₫</span>
                </div>
               
            </div>
            <input type="button" value='Thanh Toán'  className={cx('wrapPayBody_right_Sumpay_btn')}/>
